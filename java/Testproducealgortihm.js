...
//Establish Water Areas Lat
const ELCW_West_Top_P1_Lat = 40.69631;
const ELCW_West_Bottom_P1_Lat = 40.67497;
const ELCW_East_Top_P1_Lat = 40.69631;
const ELCW_East_Bottom_P1_Lat = 40.67497;
const ELCW_West_Top_P2_Lat = 40.67496;
const ELCW_West_Bottom_P2_Lat = 40.63303;
const ELCW_East_Top_P2_Lat = 40.67496;
const ELCW_East_Bottom_P2_Lat = 40.63303;
const ClctveHrsTh_Bottom_P1_Lat = 40.45784;
const ClctveHrsTh_Top_P1_Lat = 40.63302;



//Establish Water Areas Long
const ELCW_West_Top_P1_Long = -105.09358;
const ELCW_West_Bottom_P1_Long = -105.09358;
const ELCW_East_Top_P1_Long = -105.02114;
const ELCW_East_Bottom_P1_Long = -105.02114;
const ELCW_West_Top_P2_Long = -105.09564;
const ELCW_West_Bottom_P2_Long = -105.09564;
const ELCW_East_Top_P2_Long = -104.98303;
const ELCW_East_Bottom_P2_Long = -104.98303;
const ClctveHrsTh_Bottom_P1_Long = -105.13804;
const ClctveHrsTh_East_P1_Long = -104.47062;
...
//Water Source---------------
    ...
    //East Larimer County Water P1
   // if (latitude < ELCW_West_Top_P1_Lat && latitude > ELCW_West_Bottom_P1_Lat && longitude > ELCW_West_Bottom_P1_Long && longitude < ELCW_East_Bottom_P1_Long){
     // document.getElementById('Elevation').innerHTML = 'Elevation: 5000';
    //  document.getElementById('WaterSource').innerHTML = "City Water Source: Horsetooth Reservoir";
   // }
    //East Larimer County Water P2
    //else if (latitude < ELCW_West_Top_P2_Lat && latitude > ELCW_West_Bottom_P2_Lat && longitude > ELCW_West_Bottom_P2_Long && longitude < ELCW_East_Bottom_P2_Long){
      //document.getElementById('Elevation').innerHTML = 'Elevation: 5000';
      //document.getElementById('WaterSource').innerHTML = "City Water Source: Horsetooth Reservoir";
    //}

    //Collective Horse Tooth Area P1
    //else if (latitude < ClctveHrsTh_Top_P1_Lat && latitude > ClctveHrsTh_Bottom_P1_Lat && longitude > ClctveHrsTh_Bottom_P1_Long && longitude < ClctveHrsTh_East_P1_Long){
      //document.getElementById('Elevation').innerHTML = 'Elevation: 5000';
      //document.getElementById('WaterSource').innerHTML = "City Water Source: Horsetooth Reservoir";
    //}

    //All Other Non-Marked Water
    //else{
      //document.getElementById('Elevation').innerHTML = 'Elevation: Unknown';
     // document.getElementById('WaterSource').innerHTML = "Local Sourced Well Water";
    //}
...
function applewin(){
  ...
  setTimeout(function() {
    location.replace("yakimavalley.html");
}, 6700)
}
...
//Lat and Long
document.getElementById('lat').innerHTML = 'Latitude: ' + latitude + ', Longitude: ' + longitude;
...
if(final_apple <= 1){
document.getElementById('apple').innerHTML = 'Apples | <a href  = "yakimavalley.html"> Distance </a> From Source: ' + Math.round(10*d_Farm_EastWashington)/10 + ' miles';
}
else {}
...
var final_apple = d_Farm_EastWashington/1300;
if(final_apple <= 1){
document.getElementById('apple').innerHTML = 'Apples | <a onclick="applewin()"> Distance </a> From Source: ' + Math.round(10*d_Farm_EastWashington)/10 + ' miles';
}
else {}
