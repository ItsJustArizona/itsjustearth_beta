...
function showPosition(position) {
  ...
  if (position.coords.latitude >-90 && position.coords.latitude < 90 && position.coords.longitude > -180 && position.coords.longitude <180){
  setTimeout(function() {
  ...
  //if (position.coords.latitude > 40.56888611111111 && position.coords.latitude < 40.57823055555557 && //position.coords.longitude > -105.09583333333333 && position.coords.longitude < -105.07885833333333) {     
    //setTimeout(function() {
      //location.replace("ColoradoStateUni.html");
    //}, 10500);
  //}
